...
public class ListDirectoryTest extends TokenReceivingTest {
	...
	public void filledDirectory() {
		...
		assertEquals("Dimension of otherCanNotList is incorrect", otherCanNotList.dimension(), lds.get(6).getDimension());
		...
		assertEquals("Last Modified date of otherCanNotList is incorrect", otherCanNotList.getLastModified(), lds.get(6).getLastModified());
		...
		assertEquals("Dimension of ownerCanNotList is incorrect", ownerCanNotList.dimension(), lds.get(7).getDimension());
		...
		assertEquals("Last Modified date of ownerCanNotList is incorrect", ownerCanNotList.getLastModified(), lds.get(7).getLastModified());
