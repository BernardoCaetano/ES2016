...
public class Execute extends MyDriveCommand {
	...
	public void execute(String[] args) {
		...
		if (args.length < 1)
			throw new RuntimeException("USAGE: '" + getName() + " <path>' to  exexute a file in path <path> or '" + getName() + " <path> <args>' to exexute a file with the arguments <args> in path <path> ");
